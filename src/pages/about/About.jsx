...
const About = () => {
  return (
    <div className='min-h-screen text-black flex flex-col justify-center gap-16 py-24 bg-slate-50'>
      <main className='flex flex-col w-5/6 mx-auto gap-8 bg-gray-200 rounded-lg p-4'>
        <h1 className='text-4xl font-bold'>Your Ultimate Shopping Destination</h1>
        <p className='text-lg'>
      ...
      <section className='grid grid-cols-1 md:grid-cols-2 w-4/5 mx-auto gap-2'>
        <div className='flex flex-col justify-start gap-12 px-4'>
          <h2 className='text-3xl font-bold'>Our Passion for Fashion</h2>
          <p className='text-lg '>
        ...
        <div className='bg-red-500 '>
          <img className='h-96 w-full object-contain' src={men} alt='' />
        </div>
      </section>
      <section className='grid grid-cols-1 md:grid-cols-2 w-4/5 mx-auto gap-2'>
        <div className='flex flex-col justify-start gap-12 px-4'>
          <h2 className='text-3xl font-bold'>Sparkle and Shine with Our Jewelry Collection</h2>
          <p className='text-lg '>
        ...
        <div className='bg-red-500 lg:order-first '>
          <img className='h-96 w-full object-contain' src={pendant} alt='' />
        </div>
      </section>
      <section className='grid grid-cols-1 md:grid-cols-2 w-4/5 mx-auto gap-2'>
        <div className='flex flex-col justify-start gap-12 px-4'>
          <h2 className='text-3xl font-bold'>Tech Savvy and Beyond</h2>
          <p className='text-lg '>
        ...
        <div className='bg-red-500'>
          <img className='h-96 w-full object-contain' src={laptop} alt='' />
        </div>
      </section>
    </div>
  );
